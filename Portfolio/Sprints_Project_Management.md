...
<tr>
 ...
 <br>Bob </a> As a user, I want to have face to face communication with others during the gameplay, so that I can socialise with others.</td>
 <td>Start page.</td>
...
<tr>
 ...
 <a href="https://github.com/ChrisEssery/group-project/blob/dev/Portfolio/UX_Design.md#identification-of-users-and-stakeholders">
 <br>Simon </a> As a user, I want to have face to face communication with others during the gameplay, so that I can socialise with others.</td>
 <td>Multiplayer</td>
...
<tr>
 ...
 <a href="https://github.com/ChrisEssery/group-project/blob/dev/Portfolio/UX_Design.md#identification-of-users-and-stakeholders">
 <br>Sally </a> As a user, I want to have face to face communication with others during the gameplay, so that I can socialise with others.</td>
 <td>Multiplayer.</td>
 <td>Research multiplayer APIs</td>
